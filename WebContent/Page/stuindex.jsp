<%@page import="com.zsw.entity.Student"%>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
      	<li class="layui-nav-item"><a href="javascript:;" data-src="Page/stulackbed.jsp">缺寝记录</a></li>
        <li class="layui-nav-item"><a href="javascript:;" data-src="Page/stuupdate.jsp">个人信息</a></li>
      </ul>
    </div>
  </div>
